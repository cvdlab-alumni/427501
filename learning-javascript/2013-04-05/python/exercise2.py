...
three_square = MKPOL([[[10.4,0],[21.3,0],[21.3,12.2],[9,12.2],[9,9.45]],[[1,2,5],[3,4,5],[2,3,5]],None])
...
floor2 = STRUCT([T([3])([+0.14+2.36+0.14+2.36])(PROD([three_square,Q(0.14)])),empty_square])
...
#five_square = GRID([[-9.4,11.9],[9.2,3],[-9,0.14]])
